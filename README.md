# Frengo - GitHub Test Davide Configurations

This repository contains all the configuration resources required for the Frengo - GitHub Test Davide project to function properly and expose its business features.
